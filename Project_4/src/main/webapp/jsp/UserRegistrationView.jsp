        ...
        <center>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="firstName" size="23"  placeholder="Enter First Name" 
                        value="<%=DataUtility.getStringData(bean.getFirstName())%>"></td><td style="position: fixed"><font
                        color="red"> <%=ServletUtility.getErrorMessage("firstName", request)%></font></td>
                </tr>
                <tr>
                    <th align="left">Last Name<span style="color : red">*</span></th>
                    <td><input type="text" name="lastName" size="23" placeholder="Enter Last Name"
                ...
                <tr>
                    ...
                    <td><input type="text" name="login" size="23"  placeholder="Enter Login Id"
                ...
                <tr>
                 ...
                 <tr> 
                     ...
                     <td><input type="password" name="confirmPassword" size="23" placeholder="Enter Confirm Password"
				...
				<tr> 
                     ...
                     <td><input type="text" name="mobilenumber" size="23" maxlength="10" placeholder="Enter Mobile Number" 
                ...
                <tr>
                    ...
                    <td><input type="text" name="dob" readonly="readonly"  id="datepicker" size="23" placeholder=" Enter Date of Birth " 
