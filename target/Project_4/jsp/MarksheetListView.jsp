...
<jsp:useBean id="ben" class="in.co.rays.project4.bean.MarksheetBean" scope="request"></jsp:useBean>
...
<%
            ...
            <table width="100%" align="center"" >
                <tr>
                    <td align="center"><label> Name :</label> <input type="text" placeholder="Enter a Name"
                        ...
                        &emsp;
                         <label>RollNo :</label><%=HTMLUtility.getList("fname", String.valueOf(ben.getId()), rlist)%>&emsp;
            ...
            <table border="1" width="100%" align="center" cellpadding=6px
				...
				<%
					while (it.hasNext()) {
							...
							int phy = DataUtility.getInt(DataUtility.getStringData(ben.getPhysics()));
							int chem = DataUtility.getInt(DataUtility.getStringData(ben.getChemistry()));
							int math = DataUtility.getInt(DataUtility.getStringData(ben.getMaths()));
				...
				<tr align="center">
					...
					<td><%=ben.getRollNo()%></td>
					<td><%=ben.getName()%></td>
					<td><%=ben.getPhysics()%></td>
					<td><%=ben.getChemistry()%></td>
					<td><%=ben.getMaths()%></td>
					<td><%=total%></td>
					<td>
						<%
 ...
 %>
          ...
          <td> <a href="MarksheetCtl?id=<%=ben.getId()%>"> Edit</a>
                <%
                    }
                %>
            </table>
           <table width="100%">
				...
				<% if (pageNo==1){ %>
					...
					<td><input type="submit" name="operation"
						...
						if(list.size()<pageSize || model.nextPK()-1 == ben.getId()){ 
