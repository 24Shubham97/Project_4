			...
			<table>
				...
				<tr>
					...
					: DataUtility.getString(request.getParameter("oldPassword")))%>><font
						color="red"> <%=ServletUtility.getErrorMessage("oldPassword", request)%></td><td style="position: fixed"></font></td>
				</tr>
				...
				<tr>
					...
					<td><input type="password" name="newPassword" size=25 placeholder="Enter Your new password" 
						...
						<font color="red"> <%=ServletUtility.getErrorMessage("newPassword", request)%></td><td style="position: fixed"></font></td>
				</tr>
				...
				<tr>
					...
					: DataUtility.getString(request.getParameter("confirmPassword")))%>>
						<font color="red"> <%=ServletUtility.getErrorMessage("confirmPassword", request)%></td><td style="position: fixed"></font></td>
				</tr>
