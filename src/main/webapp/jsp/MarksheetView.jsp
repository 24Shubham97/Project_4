		...
		<center>
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" size="23" name="physics"placeholder="Enter your Physics marks"
						 	 ></td>
				...
				<tr>
					...
					<td><input type="text" size="23" name="chemistry"
				...
				<tr>
					...
					<td><input type="text" size="23" name="maths"
						placeholder="Enter your Physics marks"
